...
test('constructor()', (t) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    yield t.resolves(() => __awaiter(void 0, void 0, void 0, function* () {
...
test('Store as async iterator', (t) => __awaiter(void 0, void 0, void 0, function* () {
    yield t.test('async iterator for empty store', (t) => __awaiter(void 0, void 0, void 0, function* () {
        var e_2, _d, e_3, _e;
        try {
    ...
    yield t.test('async iterator', (t) => __awaiter(void 0, void 0, void 0, function* () {
        var e_4, _h, e_5, _j;
        try {
...
test('async get()', (t) => __awaiter(void 0, void 0, void 0, function* () {
    yield t.test('return null for non existing key', (t) => __awaiter(void 0, void 0, void 0, function* () {
        var e_6, _m;
        try {
    ...
    yield t.test('store string key/val', (t) => __awaiter(void 0, void 0, void 0, function* () {
        var e_7, _q;
        try {
    ...
    yield t.test('store object value', (t) => __awaiter(void 0, void 0, void 0, function* () {
        var e_8, _t;
        try {
...
test('async keys()', (t) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        for (var _5 = __asyncValues(storeFixture()), _6; _6 = yield _5.next(), !_6.done;) {
            ...
            let count = 0;
            try {
                for (var _7 = (e_12 = void 0, __asyncValues(store.keys())), _8; _8 = yield _7.next(), !_8.done;) {
                    const _ = _8.value;
                    count++;
                }
            }
            ...
            yield store.set(KEY, VAL);
            try {
                for (var _9 = (e_13 = void 0, __asyncValues(store.keys())), _10; _10 = yield _9.next(), !_10.done;) {
                    const key = _10.value;
...
test('async values()', (t) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        for (var _14 = __asyncValues(storeFixture()), _15; _15 = yield _14.next(), !_15.done;) {
            ...
            let count = 0;
            try {
                for (var _16 = (e_15 = void 0, __asyncValues(store.values())), _17; _17 = yield _16.next(), !_17.done;) {
                    const _ = _17.value;
                    count++;
                }
            }
            ...
            yield store.set(KEY, VAL);
            try {
                for (var _18 = (e_16 = void 0, __asyncValues(store.values())), _19; _19 = yield _18.next(), !_19.done;) {
